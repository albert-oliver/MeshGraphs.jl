...
function get_graph()
    ...
    # vertices
    add_vertex_xyz!(g, [2.0, 11.0, 0.0]) # 1
    add_vertex_xyz!(g, [0.0, 9.0, 0.0])  # 2
    add_vertex_xyz!(g, [0.0, 2.0, 0.0])  # 3
    add_vertex_xyz!(g, [4.5, 0.0, 0.0])  # 4
    add_vertex_xyz!(g, [8.5, 3.0, 0.0])  # 5
    add_vertex_xyz!(g, [9.0, 7.5, 0.0])  # 6
    add_vertex_xyz!(g, [4.5, 10.0, 0.0]) # 7
